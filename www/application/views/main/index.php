...
<section class="row infoblocks">
    <div class="container">
        <h2>Преимуществом автошколы является работа опытных сотрудников – профессионалов, а так же реализована своя площадка в 30 метрах от учебного класса – автоподготовки. Обучение в городе происходит около здания МПТ, курсанты катаются в районе Нахимовского проспекта.</h2>
        <div class="row">
            <div class="span3">
                <div class="grid">
    ...
    <div class="container">
        <div class="row">
            <div class="span6">
                <h1>Контакты</h1>
                <div class="">
                    <abbr title="Телефон">Тел. 1</abbr>: +7 (925) 800 10 24<br>
