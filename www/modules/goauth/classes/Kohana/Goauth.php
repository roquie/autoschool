...
class Kohana_Goauth
{
    ...
    protected $urlAuth = 'https://accounts.google.com/o/oauth2/auth';
    protected $urlToken = 'https://accounts.google.com/o/oauth2/token';
    ...
    protected function _postRequest($params)
    {
        $ch = curl_init();
