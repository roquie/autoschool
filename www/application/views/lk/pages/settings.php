...
<div class="row settingsContent">
    ...
    <div class="span4">
        ...
        <form id="check_pass" action="<?=URL::site('lk/ajax/check_pass')?>" class="_lk_form" data-callback="check_pass" method="POST" >
        ...
        <form id="change_email" action="<?=URL::site('lk/ajax/change_email')?>" method="POST" class="_lk_form" style="padding-bottom: 50px; display: none" novalidate>
            <div class="input-prepend">
